...
exports.context = function(programDescriptorPath, packageDescriptorPath, options, callback) {
	...
	Context.prototype.getInfo = function(callback) {
        ...
        info.program = {
            ...
            descriptor: context.__proto__._descriptors.program.combined
        };
        info.package = {
            path: info.context.paths.package,
            id: context.__proto__._descriptors.package.combined.id,
            descriptor: context.__proto__._descriptors.package.combined
        };
