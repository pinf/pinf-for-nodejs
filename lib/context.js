...
exports.context = function(programDescriptorPath, packageDescriptorPath, options, callback) {
	...
	Context.prototype.startProgram = function(callback) {
		return this.updateRuntimeConfig(["pinf/0/runtime/control/0", "program"], {
			started: true
		}, callback);
	}

	Context.prototype.stopProgram = function(callback) {
		return this.clearRuntimeConfig(["pinf/0/runtime/control/0", "program"], function(err) {
			if (err) return callback(err);
			return callback(null, {});
		});
	}
	...
	Context.prototype.getProgramStatus = function(callback) {
		return this.getRuntimeConfig(["pinf/0/runtime/control/0", "program"], callback);
	}
